 ...
 * theme="light"  → navy text  (#0A1428) on cream/white backgrounds  (Navbar)
 * theme="dark"   → cream text (#F8F7F4) on navy backgrounds          (Footer, Login)
 *
 * Icon: two smooth cupped hands cradling a standing person with a heart.
 * Matches the approved clean line-art design (light PNG reference).
 * Wordmark: single <text> with <tspan> — bold DOZ + regular EY, no gap.
 */
export function DozeyLogo({ className = 'h-12', theme = 'light' }: DozeyLogoProps) {
  ...
  return (
    <svg
      ...
      fill="none"
    >
      {/* ── ICON: 56px wide column, vertically centred 0–58px ── */}
      ...
      {/* LEFT HAND — smooth cupped palm rising from bottom-left */}
      <path
        d="
          M4 56
          C3 50 3 42 6 34
          C7.5 29 10 27.5 12 30
          C13 27.5 15.5 27 17 29
          C18 27 20.5 27 21.5 29.5
          C22.5 27.5 25 27.5 25.5 30
          L26 35
          C26 35 24 33.5 23 34.5
          C22 35.5 22.5 37 23.5 37.5
          L20 40
          C18.5 41.5 17.5 44 17.5 47
          L17.5 51
          C17.5 52.5 16 53 15 52
          L12 49
          C9.5 47 7 51 4 56 Z
        "
      ...
      <path
        d="
          M52 56
          C53 50 53 42 50 34
          C48.5 29 46 27.5 44 30
          C43 27.5 40.5 27 39 29
          C38 27 35.5 27 34.5 29.5
          C33.5 27.5 31 27.5 30.5 30
          L30 35
          C30 35 32 33.5 33 34.5
          C34 35.5 33.5 37 32.5 37.5
          L36 40
          C37.5 41.5 38.5 44 38.5 47
          L38.5 51
          C38.5 52.5 40 53 41 52
          L44 49
          C46.5 47 49 51 52 56 Z
        "
        stroke={green} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
      />

      {/* ── WORDMARK — single text run, tspan for weight variation ── */}
      <text
        x="64"
        y="51"
