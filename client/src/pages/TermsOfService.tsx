    ...
    <div className="min-h-screen bg-[#f5f5f7]">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-8">
          <Link to="/" className="text-[#0A1428] hover:text-[#1F2937] transition-colors">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-[#f5f5f7] p-8 md:p-12">
          <h1 className="text-3xl font-bold text-[#0A1428] mb-2">Terms of Service</h1>
          <p className="text-[#6B7280] mb-8">Last Updated: February 23, 2026</p>

          <div className="prose prose-gray max-w-none space-y-6 text-[#0A1428]">
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">1. Acceptance of Terms</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">2. Description of Service</h2>
              <p className="text-[#0A1428] leading-relaxed">
              ...
              <p className="text-[#0A1428] leading-relaxed font-medium">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">3. HIPAA Compliance and Protected Health Information (PHI)</h2>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 mb-4">
                <h3 className="font-semibold text-[#0A1428] mb-2">Important HIPAA Notice</h3>
                <p className="text-[#0A1428] text-sm leading-relaxed">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.1 Our Commitment to HIPAA Compliance</h3>
              <p className="text-[#0A1428] leading-relaxed">We are committed to handling your health information in compliance with applicable laws and regulations, including:</p>
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.2 Administrative Safeguards</h3>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.3 Technical Safeguards</h3>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.4 Physical Safeguards</h3>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.5 Your Rights Under HIPAA</h3>
              <p className="text-[#0A1428] leading-relaxed">As a user of DOZEY, you have the following rights regarding your PHI:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.6 Breach Notification</h3>
              <p className="text-[#0A1428] leading-relaxed">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.7 Business Associate Agreements</h3>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">4. User Accounts and Registration</h2>
              <p className="text-[#0A1428] leading-relaxed">To use the Service, you must:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">5. User Responsibilities</h2>
              <p className="text-[#0A1428] leading-relaxed">By using the Service, you agree to:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">6. Data Collection and Use</h2>
              <p className="text-[#0A1428] leading-relaxed">We collect and process the following types of information:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">7. AI-Powered Features and Data Processing</h2>
              <p className="text-[#0A1428] leading-relaxed">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">7.1 AI Data Processing Safeguards</h3>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">7.2 AI Accuracy Disclaimer</h3>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">8. Data Sharing and Disclosure</h2>
              <p className="text-[#0A1428] leading-relaxed">We may share your information only in the following circumstances:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">9. Data Retention and Deletion</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">10. Intellectual Property</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">11. Disclaimer of Warranties</h2>
              <p className="text-[#0A1428] leading-relaxed uppercase text-sm font-medium">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">12. Limitation of Liability</h2>
              <p className="text-[#0A1428] leading-relaxed uppercase text-sm font-medium">
              ...
              <p className="text-[#0A1428] leading-relaxed uppercase text-sm font-medium mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">13. Indemnification</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">14. International Users</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">15. Modifications to Terms</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">16. Termination</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">17. Governing Law and Dispute Resolution</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">18. HIPAA Sanctions Policy</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">19. De-identification and Anonymization</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">20. Audit Trail and Activity Logging</h2>
              <p className="text-[#0A1428] leading-relaxed">DOZEY maintains comprehensive audit trails as required by the HIPAA Security Rule, including:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">21. Security Incident Response</h2>
              <p className="text-[#0A1428] leading-relaxed">DOZEY maintains a formal Security Incident Response Plan that includes:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">22. Contingency Planning</h2>
              <p className="text-[#0A1428] leading-relaxed">DOZEY maintains contingency plans as required by the HIPAA Security Rule, including:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">23. Miscellaneous</h2>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">24. Contact Information</h2>
              <p className="text-[#0A1428] leading-relaxed">
              ...
              <div className="bg-[#f5f5f7] rounded-lg p-4 mt-2">
                <p className="text-[#0A1428]"><strong>DOZEY Inc.</strong></p>
                <p className="text-[#0A1428]">Email: legal@dozeyrecords.com</p>
                <p className="text-[#0A1428]">Privacy Officer: privacy@dozeyrecords.com</p>
                <p className="text-[#0A1428]">HIPAA Inquiries: hipaa@dozeyrecords.com</p>
                <p className="text-[#0A1428]">Website: dozeyrecords.com</p>
              </div>
            </section>
          </div>
        </div>
