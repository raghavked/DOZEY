    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-green-50/20">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 md:p-12">
          <h1 className="text-3xl font-bold text-[#22283a] mb-2">Terms of Service</h1>
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-[#22283a]">
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">1. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">2. Description of Service</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">3. HIPAA Compliance and Protected Health Information (PHI)</h2>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 mb-4">
                <h3 className="font-semibold text-[#1051a5] mb-2">Important HIPAA Notice</h3>
              ...
              <h3 className="font-semibold text-[#22283a] mt-4 mb-2">3.1 Our Commitment to HIPAA Compliance</h3>
              ...
              <h3 className="font-semibold text-[#22283a] mt-4 mb-2">3.2 Administrative Safeguards</h3>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <h3 className="font-semibold text-[#22283a] mt-4 mb-2">3.3 Technical Safeguards</h3>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <h3 className="font-semibold text-[#22283a] mt-4 mb-2">3.4 Physical Safeguards</h3>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <h3 className="font-semibold text-[#22283a] mt-4 mb-2">3.5 Your Rights Under HIPAA</h3>
              ...
              <h3 className="font-semibold text-[#22283a] mt-4 mb-2">3.6 Breach Notification</h3>
              <p className="text-gray-700 leading-relaxed">
              ...
              <h3 className="font-semibold text-[#22283a] mt-4 mb-2">3.7 Business Associate Agreements</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">4. User Accounts and Registration</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">5. User Responsibilities</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">6. Data Collection and Use</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">8. Data Sharing and Disclosure</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">9. Data Retention and Deletion</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">10. Intellectual Property</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">11. Disclaimer of Warranties</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">12. Limitation of Liability</h2>
              <p className="text-gray-700 leading-relaxed uppercase text-sm font-medium">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">13. Indemnification</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">14. International Users</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">15. Modifications to Terms</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">16. Termination</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#1051a5] mt-8 mb-3">17. Governing Law and Dispute Resolution</h2>
              <p className="text-gray-700 leading-relaxed">
