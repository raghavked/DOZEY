        ...
        <div className="bg-white rounded-2xl shadow-xl border border-[#f5f5f7] p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-[#1d1d1f]">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">We are committed to handling your health information in compliance with applicable laws and regulations, including:</p>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">As a user of DOZEY, you have the following rights regarding your PHI:</p>
              <ul className="list-disc pl-6 text-[#1d1d1f] space-y-1">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">To use the Service, you must:</p>
              <ul className="list-disc pl-6 text-[#1d1d1f] space-y-1">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">By using the Service, you agree to:</p>
              <ul className="list-disc pl-6 text-[#1d1d1f] space-y-1">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">We collect and process the following types of information:</p>
              <ul className="list-disc pl-6 text-[#1d1d1f] space-y-1">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">We may share your information only in the following circumstances:</p>
              <ul className="list-disc pl-6 text-[#1d1d1f] space-y-1">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed uppercase text-sm font-medium">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed uppercase text-sm font-medium mt-2">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">DOZEY maintains comprehensive audit trails as required by the HIPAA Security Rule, including:</p>
              <ul className="list-disc pl-6 text-[#1d1d1f] space-y-1">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">DOZEY maintains a formal Security Incident Response Plan that includes:</p>
              <ul className="list-disc pl-6 text-[#1d1d1f] space-y-1">
            ...
            <section>
              ...
              <p className="text-[#1d1d1f] leading-relaxed">DOZEY maintains contingency plans as required by the HIPAA Security Rule, including:</p>
              <ul className="list-disc pl-6 text-[#1d1d1f] space-y-1">
            ...
            <section>
              ...
              <div className="bg-[#f5f5f7] rounded-lg p-4 mt-2">
                <p className="text-[#1d1d1f]"><strong>DOZEY Inc.</strong></p>
                <p className="text-[#1d1d1f]">Email: legal@dozeyrecords.com</p>
                <p className="text-[#1d1d1f]">Privacy Officer: privacy@dozeyrecords.com</p>
                <p className="text-[#1d1d1f]">HIPAA Inquiries: hipaa@dozeyrecords.com</p>
