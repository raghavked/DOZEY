    ...
    <div className="min-h-screen bg-[#f5f5f7]">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-[#f5f5f7] p-8 md:p-12">
          <h1 className="text-3xl font-bold text-[#0A1428] mb-2">Privacy Policy & HIPAA Notice of Privacy Practices</h1>
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-[#0A1428]">
            <div className="bg-green-50 border border-green-200 rounded-lg p-5 mb-6">
              <h3 className="font-semibold text-[#10B981] mb-2">Your Privacy Matters</h3>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">1. Information We Collect</h2>

              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">1.1 Information You Provide</h3>
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">1.2 Information Collected Automatically</h3>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">2. How We Use Your Information</h2>
              <p className="text-[#0A1428] leading-relaxed">We use your information for the following purposes:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">3. HIPAA-Specific Privacy Practices</h2>

              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.1 Uses and Disclosures of PHI</h3>
              <p className="text-[#0A1428] leading-relaxed">We may use and disclose your PHI in the following ways:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.2 Uses and Disclosures Requiring Your Written Authorization</h3>
              <p className="text-[#0A1428] leading-relaxed">We will obtain your written authorization before:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">3.3 Minimum Necessary Standard</h3>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">4. Data Security</h2>
              <p className="text-[#0A1428] leading-relaxed">We implement comprehensive security measures to protect your information:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">5. Third-Party Service Providers</h2>
              <p className="text-[#0A1428] leading-relaxed">We use the following categories of third-party service providers, all bound by Business Associate Agreements (BAAs) or equivalent data processing agreements:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">5.1 AI Data Processing Details</h3>
              <p className="text-[#0A1428] leading-relaxed">When you use AI-powered features, your data is processed as follows:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">6. Your Rights</h2>

              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">6.1 HIPAA Rights</h3>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
              ...
              <h3 className="font-semibold text-[#0A1428] mt-4 mb-2">6.2 Additional Rights (GDPR, CCPA, and Other Laws)</h3>
              <p className="text-[#0A1428] leading-relaxed">Depending on your location, you may also have the right to:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">7. Data Retention</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">8. Children's Privacy</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">9. International Data Transfers</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">10. Cookies and Tracking</h2>
              <p className="text-[#0A1428] leading-relaxed">DOZEY uses only essential cookies required for the Service to function:</p>
              <ul className="list-disc pl-6 text-[#0A1428] space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">11. Your Right to File a Complaint</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">12. Changes to This Policy</h2>
              <p className="text-[#0A1428] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#0A1428] mt-8 mb-3">13. Contact Us</h2>
              <p className="text-[#0A1428] leading-relaxed">
              ...
              <div className="bg-[#f5f5f7] rounded-lg p-4 mt-2">
                <p className="text-[#0A1428]"><strong>DOZEY Inc. - Privacy Office</strong></p>
                <p className="text-[#0A1428]">Email: privacy@dozeyrecords.com</p>
                <p className="text-[#0A1428]">HIPAA Privacy Officer: hipaa@dozeyrecords.com</p>
                <p className="text-[#0A1428]">Website: dozeyrecords.com</p>
              </div>
              <p className="text-[#0A1428] leading-relaxed mt-3">
