          ...
          <div className="prose prose-gray max-w-none space-y-6 text-[#22283a]">
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mt-2">
                <p className="text-gray-700"><strong>DOZEY Inc. - Privacy Office</strong></p>
                <p className="text-gray-700">Email: privacy@dozeyrecords.com</p>
                <p className="text-gray-700">HIPAA Privacy Officer: hipaa@dozeyrecords.com</p>
