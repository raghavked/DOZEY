    ...
    <div ref={scrollRef} className="min-h-screen">
      <section className="relative min-h-[70vh] flex items-center bg-gradient-to-b from-[#0a3d7a] via-[#1051a5] to-[#1a4a8a] text-white overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/2 left-1/3 w-[500px] h-[500px] bg-[#26844f]/5 rounded-full blur-[150px]" />
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {team.map((member, index) => (
              ...
              >
                ...
                <h2 className="text-lg font-semibold text-[#22283a] mb-1">{member.name}</h2>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-xs text-gray-300 hover:text-[#1051a5] transition-colors"
                >
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="animate-on-scroll bg-white rounded-2xl p-8 text-center">
              <GraduationCap className="w-6 h-6 text-[#22283a]/30 mx-auto mb-4" />
              <h3 className="text-base font-semibold text-[#22283a] mb-1">UC Davis</h3>
              <p className="text-sm text-gray-400 leading-relaxed">Built at UC Davis with EIR mentorship, research resources, and a world-class innovation ecosystem.</p>
            </div>
            <div className="animate-on-scroll delay-200 bg-white rounded-2xl p-8 text-center">
              <Trophy className="w-6 h-6 text-[#22283a]/30 mx-auto mb-4" />
              <h3 className="text-base font-semibold text-[#22283a] mb-1">Award-Winning</h3>
              <p className="text-sm text-gray-400 leading-relaxed">Recognized at Hult Prize Regionals for our innovative approach to global healthcare challenges.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-[#fefefe]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-on-scroll">
            <h2 className="text-3xl lg:text-4xl font-semibold text-[#22283a] mb-4">
