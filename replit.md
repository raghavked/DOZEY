...
## Recent Changes
- 2026-02-24: Residence history now supports optional month precision (startMonth/endMonth) for more specific date ranges; AI document processing pipeline uses residence history to suggest immunization locations when documents lack explicit location data (clearly marked as inferred, user-verified)
